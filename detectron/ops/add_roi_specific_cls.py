...
from detectron.roi_data.roi_specific_cls import get_roi_various_patch
# import pydevd
class AddRoiSpecificClsOp(object):
    ...
    def forward(self, inputs, outputs):
        ...
        if self._train:
            ...
            output_blob_names = roi_specific_cls_roi_data.get_roi_specific_cls_blob_names()
            blobs = {k: [] for k in output_blob_names}
            roi_specific_cls_roi_data.add_roi_specific_cls_blobs(blobs, rois,pred_cls,label)
